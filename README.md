...
|--------|-----|------|-------|------|-------|-------|--------|
| 200×200 | 107.28 | 0.65 | 0.56 | 0.58 | 0.56 | **0.53** | 32×32 |
...
- **Для малых матриц (200×200)**: Первый запуск (8×8) показывает аномально большое время из-за инициализации GPU. Оптимальный блок — 32×32.
